...
export default function SubscriptionPage() {
  ...
  const headers = () => ({ Authorization: `Bearer ${localStorage.getItem('streammind_token')}` });
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-hally-text-muted text-sm">Gestisci il tuo piano StreamMind e la fatturazione.</p>
      </div>
        ...
        {loading ? (
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <p className="text-hally-text-muted text-sm">
              Scegli un piano qui sotto per attivare StreamMind sul tuo canale.
            </p>
          </div>
        )}
      </div>
